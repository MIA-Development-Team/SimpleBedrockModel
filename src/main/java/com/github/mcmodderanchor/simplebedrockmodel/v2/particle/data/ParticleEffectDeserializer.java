package com.github.mcmodderanchor.simplebedrockmodel.v2.particle.data;

import com.github.mcmodderanchor.simplebedrockmodel.v2.particle.data.component.*;
import com.github.mcmodderanchor.simplebedrockmodel.v2.particle.data.curve.ParticleCurve;
import com.github.mcmodderanchor.simplebedrockmodel.v2.particle.data.event.*;
...
import static com.github.mcmodderanchor.simplebedrockmodel.v2.particle.data.ParticleJsonUtils.*;
...
public class ParticleEffectDeserializer {
    ...
    private ParticleDescription parseDescription(JsonObject obj) {
        ...
        Identifier texture = Identifier.fromNamespaceAndPath("minecraft", "textures/particle/generic_0.png");
        int texW = 0, texH = 0;
